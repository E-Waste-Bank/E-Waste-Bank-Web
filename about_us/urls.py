...
from about_us.views import show_about_us, get_feedback_json, add_feedback, show_feedback_by_id, add_feedback_flutter
...
urlpatterns = [
    ...
    path('add-feedback-flutter/', add_feedback_flutter, name='add_feedback_flutter')
]